package com.app.bluarry.config;
...
*/
    ...
    //Real
    public static final String DOMAIN_NAME = "http://bluarry.top/carbon" + WEBSITE_PATH; // Main domain name
    public static final String MOBILE_DOMAIN_NAME = "http://bluarry.top/carbon" + WEBSITE_PATH; // Domain name of mobile version
    public static final String BASIC_API_URL = "http://api.bluarry.top/carbon" + WEBSITE_PATH; // Domain name of API
