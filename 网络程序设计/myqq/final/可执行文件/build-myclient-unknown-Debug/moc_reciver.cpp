...
static const char qt_meta_stringdata_Reciver[] = {
    "Reciver\0\0on_filetranscancle_clicked()\0"
    "recivefile()\0"
};
...
void Reciver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_filetranscancle_clicked(); break;
        case 1: _t->recivefile(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData Reciver::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Reciver::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Reciver,
      qt_meta_data_Reciver, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Reciver::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Reciver))
